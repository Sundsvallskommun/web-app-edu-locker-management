describe('Use create lockers dialog', () => {
  ...
  it('creates lockers', () => {
    ...
    cy.get('[data-test="create-lockers-building"]').select('Flygeln');
    cy.get('[data-test="create-lockers-buildingFloors"]').should('be.disabled');

    cy.get('[data-test="create-lockers-building"]').select('Annex');
    ...
    cy.get('[data-test="create-lockers-buildingFloors"]').should('have.value', '');
    cy.get('[data-test="create-lockers-buildingFloors"]').children().should('have.length', 4);
    ...
    cy.get('[data-test="create-lockers-buildingFloors"]').select('1');
